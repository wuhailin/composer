...
class Order extends CActiveRecord
{
    ...
    public function relations()
    {
        ...
        return array(
            'member'  => [self::HAS_ONE, 'common\model\Members', 'userID', 'condition' => 'userType = "Members"'],
            'server'  => [self::HAS_ONE, 'common\model\Server', 'serverID'],
            'payment' => [self::HAS_ONE, 'common\model\Payment', 'paymentID'],
        );
    }
