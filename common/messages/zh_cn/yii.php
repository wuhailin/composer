...
return array (
  ...
  '{attribute} "{value}" has already been taken.' => '{attribute}提供的"{value}"已被使用.',
  ...
  '{attribute} is of the wrong length (should be {length} characters).' => '{attribute}长度错误 (应为 {length} 个字符串).',
